    ...
    return (
        <>
            <BreadcrumbSchema items={[
                ...
                { name: 'Fahad Suleman', url: 'https://quecko.com/about-us/team/fahad' },
            ]} />
            <section className='profile_detailpage'>
                ...
                <div className='inner_side_profile'>
                    ...
                    <div className='profile_maindiv'>
                        <img className='profillle_img' src='/Assets/fahadprofile.png' />
                        <Link href="https://t.me/Ferroo155" target='_blank' rel="noopener noreferrer">
                            <img src='/Assets/sendingarrow.png' className='svgarrowss' />
                        </Link>
                    </div>
                    <div className='botttom_page'>
                        <h2>Fahad Suleman</h2>
                        <p className='cmo_content'><span>CMO</span> at Quecko</p>
                        <h3>About Me</h3>
                        <p>CMO at Quecko, Web3 marketer and blockchain development consultant helping businesses scale through innovative blockchain solutions.</p>
                        <div className='linkss_div'>
                            <Link href="https://api.whatsapp.com/send/?phone=923333480179&text&type=phone_number&app_absent=0" target='_blank' rel="noopener noreferrer">
                            ...
                            <a href="mailto:fahad@quecko.com">
                            ...
                            <Link href="https://www.linkedin.com/in/fahad-suleman-8385a25b/" target='_blank' rel="noopener noreferrer">
