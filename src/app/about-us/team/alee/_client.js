    ...
    return (
        <>
            <BreadcrumbSchema items={[
                ...
                { name: 'Alee Abbasi', url: 'https://quecko.com/about-us/team/alee' },
            ]} />
            <section className='profile_detailpage'>
                <img src='/Assets/groups.png' className='bottom_new_img' />
                <div className='inner_side_profile'>
                    <img className='top_img' src='/Assets/topimg.png' />
                    <div className='profile_maindiv'>
                        <img className='profillle_img' src='/Assets/aleeprofile.png' />
                        <Link href="https://t.me/aleeabbasi021" target='_blank' rel="noopener noreferrer">
                            <img src='/Assets/sendingarrow.png' className='svgarrowss' />
                        </Link>
                    </div>
                    <div className='botttom_page'>
                        <h2>Alee Abbasi</h2>
                        <p className='cmo_content'><span>CEO</span> at Quecko</p>
                        <h3>About Me</h3>
                        <p>I'm a Fintech and Blockchain Development consultant with a decade long experience working with multiple top 500 projects listed on CoinMarketCap</p>
                        <div className='linkss_div'>
                            <Link href="https://api.whatsapp.com/send/?phone=923005555257&text&type=phone_number&app_absent=0" target='_blank' rel="noopener noreferrer">
