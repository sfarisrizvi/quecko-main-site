export const metadata = { title: "Web3 & DeFi Solutions - Quecko", description: "Unlock the potential of Web3 and DeFi with Quecko’s innovative blockchain solutions." }
...
import Defiuses from '@/components/carousels/DefiUses';
import Defifaqs from '@/components/faqs/DefiFaqs';
...
<BreadcrumbSchema items={[
                ...
                { name: 'Web3 & DeFi Solutions', url: 'https://quecko.com/services/web3/web3-and-defi-solutions' },
            ]} />
            ...
            <section className='smart_contract'>
                    ...
                    <div className='blogdetail'>
                        <div className='parenttext'>
                            <div className='twicebtn'>
                                ...
                                <span>Web3 & DeFi Solutions</span>
                            </div>
                            <h1 className='mainpara'>Web3 & DeFi Solutions</h1>
                ...
                <div className='Development'>
                    ...
                    <div className='mains_cardss'>
                        <div className='card__one'>
                            ...
                            <h3  className='names_tags'>Decentralized Exchanges (DEX)
                            </h3>
                        ...
                        <div className='card__one'>
                            ...
                            <h3  className='names_tags'>AMM-Based DEX
                            </h3>
                        ...
                        <div className='card__one'>
                            ...
                            <h3  className='names_tags'>Order Book-Based DEX
                            </h3>
                        ...
                        <div className='card__one'>
                            ...
                            <h3  className='names_tags'>Cross-Chain DEX
                            </h3>
                ...
                <div className='Application'>
                    <div className='inner__textt'>
                        <h2  className='contratt'>Why Choose Quecko for Web3 & DeFi Solutions?
