                                ...
                                <SwiperSlide>
                                    <div className='cardss'>
                                        ...
                                        <p>Improve traceability with real-time tracking of goods from manufacturer to consumer.
                                            ...
                                            Optimize inventory management and reduce inefficiencies with automated contracts.</p>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className='cardss'>
                                        ...
                                        <p>Enable play-to-earn (P2E) models where players earn crypto rewards.
                                            ...
                                            Create decentralized virtual economies with NFT-based ownership and in-game currencies.</p>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className='cardss'>
                                        ...
                                        <p>Streamline operations with private and consortium blockchain networks.
                                            ...
                                            Improve contract management and record-keeping with immutable ledgers.</p>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className='cardss'>
                                        ...
                                        <p>Digitize real estate, stocks, bonds, and luxury goods into tradable digital tokens.
                                            ...
                                            Improve liquidity and global investment opportunities.</p>
                                    </div>
                                </SwiperSlide>
                            </Swiper>
                        </div>
