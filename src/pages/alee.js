        ...
        <>
            <section className='profile_detailpage'>
                ...
                <div className='inner_side_profile'>
                    <img className='top_img' src='\Assets\topimg.png' />
                    <div className='profile_maindiv'>
                        <img className='profillle_img' src='\Assets\aleeprofile.png' />
                        <Link href="https://t.me/aleeabbasi021" target='blank'>
                    ...
                    <div className='botttom_page'>
                        ...
                        <h3>About Me</h3>
                        <p>I’m a Fintech and Blockchain Development consultant with a decade long experience
                            working with multiple top 500 projects
                            listed on CoinMarketCap</p>
                        <div className='linkss_div'>

                            <Link href="https://api.whatsapp.com/send/?phone=923005555257&text&type=phone_number&app_absent=0" target='blank'>
                            ...
                            <Link href="https://www.quecko.com/" target='blank'>
                            ...
                            <Link href="https://www.linkedin.com/in/alee-abbasi-32183069/" target='blank'>
