            ...
            <section className='smart_contract'>
                ...
                <div className='inner_data'>
                    ...
                    <div className='blogdetail'>
                        <div className='parenttext'>
                            ...
                            <h3 className='mainpara'>Transforming Real-World Assets into Digital Opportunities
                            </h3>
                ...
                <div className='Development'>
                    ...
                    <div className='mains_cardss'>
                        <div className='card__one'>
                            ...
                            <h1>Asset Tokenization Architecture</h1>
                        ...
                        <div className='card__one'>
                            ...
                            <h1> Regulatory-Compliant Token Standards
                            </h1>
                        ...
                        <div className='card__one'>
                            ...
                            <h1> Smart Contract-Powered RWA Solutions
                            </h1>
                        ...
                        <div className='card__one'>
                            ...
                            <h1>Gas & Transaction Optimization
                            </h1>
                ...
                <div className='Application'>
                    <div className='inner__textt'>
                        <h1>Why Should Your Business Leverage RWA Tokenization?
                        </h1>
