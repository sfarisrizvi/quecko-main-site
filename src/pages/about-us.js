    ...
    <>
      ...
      <div>
        <section className="main_banner1">
          ...
          <img
            loading="lazy"
            className="upper_shadow d-none"
            src="\Assets\shadowupper.png"
            alt="about-us"
          />
          <img
            loading="lazy"
            className="lowershadow  d-none"
            src="\Assets\shadowlower.png"
            alt="about-us"
          />
          <div className="inner_banner">
            ...
            <div className="textual_inner myinnner_data">
              ...
              <div className="animation-section style-1">
                <h1>About Us</h1>
                <p className="span_ptag newtagsss">
                  At Quecko, we don’t just provide solutions; we build them.
                  We’re actively involved in creating the foundation for a
                  decentralized future, one block at a time.
                </p>
              </div>
            </div>
            <img
              ...
              className={
                direction === "down" ? "downarrow" : "downarrow setarrowup"
              }
        ...
        <section className="goalss_side">
          <div className="goals_details">
            ...
            <p>
              ...
              with the tools, technology, and expertise they need to succeed in
              a decentralized world. The digital landscape is evolving, and
          ...
          <div className="inner_collab">
            ...
            <div className="top_middle">
              <div className="middle_colab">
                <h2>Who we are?</h2>
                <p>
                  We are a team of designers, developers and marketers that
                  blend design, development, and strategy to bring bold Web3
                  ideas to life. From startups building their first smart
                  contracts to established brands entering the blockchain space,
                  we craft tailored solutions that are technically sound,
                  creatively sharp, and strategically smart.
                </p>
              </div>
            </div>{" "}
            {/* Closing div for top_middle */}
          </div>{" "}
          {/* Closing div for inner_collab */}
          <section className="goalss_side1">
            <div className="goals_details">
              <h2 className="goaldiv">Since 2020</h2>
              <div>
                <p>
                  Our story began with a small, passionate team of four
                  visionaries who believed in the transformative power of
                  blockchain technology. From these humble beginnings, Quecko
                  has grown into a powerhouse of over 100+ talented
                  professionals. Each team member represents a unique building
                  block, much like the individual blocks in a blockchain,
                  contributing to the strength, resilience, and innovation of
                  our company. Our commitment to pioneering Web3 solutions has
                  enabled us to help businesses navigate the complexities of
                  blockchain, creating decentralized applications and software
                  that drive progress and innovation. We take pride in our role
                  as the architects of a decentralized future, where every block
                  and every team member plays a crucial part in building a more
                  connected and empowered world.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="owl_option">
                <OwlCarousel className="owl-theme" {...owl_option}>
                  ...
                  <div className="cardss">
                    <div className="textual_div">
                      <span className="teamss_head">TEAM</span>
                      <h2>Meet Our Frontend Developer Team</h2>
                    </div>
                    <div className="imgusers">
