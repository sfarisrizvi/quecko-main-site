            ...
            <section className='smart_contract'>
                ...
                <div className='Development'>
                    ...
                    <div className='mains_cardss'>
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>Decentralized Exchanges (DEX)
                            </h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>AMM-Based DEX
                            </h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>Order Book-Based DEX
                            </h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>Cross-Chain DEX
                            </h5>
                ...
                <div className='Application'>
                    <div className='inner__textt'>
                        <h6  className='contratt'>Why Choose Quecko for Web3 & DeFi Solutions?
