      ...
      <section className="parentblogss">
                  ...
                  <Link href={`/${posts[0]?.slug}`}>
                    <div className="mainarrowpic">
                      <img
                        ...
                        alt="img"
                        className="img-fluid innerimg11"
                      />
                    </div>
                  </Link>
        ...
        <div className="latestblogmain">
                  ...
                  <button className="animated-button filter">
                    ...
                    >
                      <div className="front">
                        ...
                        >
                          <path
                            d="M6.99984 12.75L9.9165 9.83333M6.99984 12.75L4.08317 9.83333M6.99984 12.75L6.99984 2.25"
                            stroke="black"
                            strokeWidth="1.2"
                            strokeLinecap="round"
          ...
          {Loading ? (
            ...
            <>
              {Array.from({ length: Math.ceil(visibleCount / 8) }).map(
                (_, chunkIndex) => {
                  ...
                  return (
                    <div key={chunkIndex}>
                      ...
                      {blogData?.length > end &&
                        chunkIndex === Math.floor((visibleCount - 1) / 8) && (
                          <div className="seemore">
                            <div
                              className="see_more_botton"
                              onClick={() =>
