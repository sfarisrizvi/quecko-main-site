            ...
            <section className='smart_contract'>
                ...
                <div className='inner_data'>
                    ...
                    <div className='blogdetail'>
                        <div className='parenttext'>
                            ...
                            <h3 className='mainpara'>Enterprise & Consulting Transforming Businesses with Innovation!</h3>
                ...
                <div className='Development'>
                    ...
                    <div className='mains_cardss'>
                        <div className='card__one'>
                            ...
                            <h1>Blockchain Strategy Consulting
                            </h1>
                        ...
                        <div className='card__one'>
                            ...
                            <h1>Smart Contract Architecture & Development
                            </h1>
                        ...
                        <div className='card__one'>
                            ...
                            <h1>Private & Consortium Blockchain Solutions</h1>
                        ...
                        <div className='card__one'>
                            ...
                            <h1>Tokenomics & Business Model Design</h1>
                ...
                <div className='Application'>
                    <div className='inner__textt'>
                        <h1>Why Choose Our Enterprise & Consulting Services?
                        </h1>
