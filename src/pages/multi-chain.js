...
const multichain = () => {
            ...
            <section className='TDNS_section'>
                <div className='inner_porfolio'>
                    <div className='first_side'>
                        <div>
                            <h1>Multi Chain Crypto Wallet

                            </h1>
                            <p className='modullar_ptag'>The First AI-Powered Web3 Wallet
                            </p>
                        </div>
                        <Link href="/contact">
                    ...
                    <div className='img_first'>
                        <img src='\Assets\multi11.png' className='imgggs' />
                    </div>
                    <div className='challenge_div'>
                        <div>

                            <p>The Multi Chain Crypto Wallet redefines how users interact with crypto. Designed for seamless voice-based control, multi-chain support, and tight
                            </p>
                        </div>
                        <div>

                            <p>security, it is the first AI-powered self-custodial wallet that integrates voice, DeFi, NFTs, and dApps into one intelligent interface.
                    ...
                    <div className='goals_sidee'>
                        ...
                        <div className='imgs_seconds'>
                            <img src='\Assets\multi12.png' className='imgnew' />
                            <div>
                                <h2>AI Voice Assistant</h2>
                                <p>Your crypto companion — powered by voice. <br></br>

                                    Control your wallet using natural language commands:</p>
                                <ul>
                                    <li>
                                        Send 500 USDT to John on Ethereum??
                                    </li>
                                    <li>
                        ...
                        <div className='imgs_seconds newcardssss'>
                            <div>
                                <h2>Multichain Crypto Swap</h2>
                                <p>Instant cross-chain swaps — no bridges, no delays.
                                    Seamless in-app token swapping across major chains:</p>
                                <ul>
                                    <li>
                                        Ethereum, BNB Chain, Polygon, Solana, and more
                                    </li>
                                    <li>
                            ...
                            <img src='\Assets\multi13.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\multi14.png' className='imgnew' />
                            <div>
                                <h2>dApp Interaction Layer</h2>
                                <p>Use any dApp from inside your wallet.</p>
                                <ul>

                                    <li>Access DeFi, GameFi, SocialFi, and utility dApps</li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                            <div>
                                <h2>Super App Groups & Chat (Coming Soon)</h2>
                                <p>Private, decentralized conversations — layered on your wallet.
                                    Build private or token-gated groups inside the wallet:
                                </p>
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        Voice notes and AI summarization
                                    </li>
                                </ul>
                            </div>
                            <img src='\Assets\multi15.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\multi16.png' className='imgnew' />
                            <div>
                                <h2>Enhanced Security Layer</h2>
                                <p>Biometric-first, MEV-protected, self-custodial.</p>
                                <ul>

                                    <li>FaceID / Fingerprint login</li>
                                    <li>No seed phrase leaks — encrypted local storage</li>
                                </ul>
                            </div>
                        </div>
  ...
  <path d="M13.125 18.75V13.125C13.125 10.6386 14.1127 8.25403 15.8709 6.49587C17.629 4.73772 20.0136 3.75 22.5 3.75C24.9864 3.75 27.371 4.73772 29.1291 6.49587C30.8873 8.25403 31.875 10.6386 31.875 13.125V18.75" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <h3>Biometric APIs, Encrypted Keystore, MEV Protection</h3>

                            </div>
                            <div className='card__onee'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
  <path d="M22.4996 9.37497C22.5018 8.62503 22.354 7.88222 22.0649 7.19022C21.7759 6.49823 21.3513 5.87102 20.8163 5.3455C20.2813 4.81997 19.6466 4.40673 18.9495 4.13009C18.2525 3.85345 17.5071 3.71899 16.7574 3.73462C16.0076 3.75025 15.2685 3.91565 14.5836 4.2211C13.8986 4.52654 13.2817 4.96587 12.7691 5.51323C12.2564 6.06059 11.8584 6.70494 11.5984 7.40838C11.3384 8.11182 11.2217 8.86015 11.2552 9.60935C10.1531 9.89273 9.12988 10.4232 8.26312 11.1606C7.39636 11.8979 6.70876 12.8229 6.25239 13.8653C5.79602 14.9078 5.58286 16.0404 5.62904 17.1774C5.67522 18.3145 5.97953 19.4261 6.51893 20.4281C5.57052 21.1986 4.82473 22.1891 4.34645 23.3136C3.86816 24.438 3.67186 25.6623 3.77462 26.8799C3.87738 28.0976 4.27609 29.2716 4.93607 30.3C5.59605 31.3284 6.4973 32.18 7.56143 32.7806C7.43003 33.7973 7.50845 34.8301 7.79185 35.8153C8.07525 36.8005 8.55761 37.7172 9.20916 38.5086C9.8607 39.3001 10.6676 39.9496 11.58 40.417C12.4924 40.8844 13.4909 41.1598 14.5139 41.2262C15.5369 41.2926 16.5626 41.1486 17.5278 40.803C18.4929 40.4574 19.377 39.9176 20.1254 39.217C20.8737 38.5164 21.4705 37.6698 21.8789 36.7295C22.2872 35.7892 22.4985 34.7751 22.4996 33.75V9.37497Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <path d="M11.2559 9.60938C11.2929 10.5164 11.549 11.4009 12.0021 12.1875" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M6.51953 20.43C6.86254 20.1506 7.2296 19.9022 7.61641 19.6875" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11.2496 33.7502C9.95745 33.7508 8.68702 33.4175 7.56152 32.7827" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <path d="M35.625 24.375H28.125C26.0539 24.375 24.375 26.0539 24.375 28.125V35.625C24.375 37.6961 26.0539 39.375 28.125 39.375H35.625C37.6961 39.375 39.375 37.6961 39.375 35.625V28.125C39.375 26.0539 37.6961 24.375 35.625 24.375Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <h3> WalletConnect, dApp browser SDK</h3>
