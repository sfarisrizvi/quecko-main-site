...
<p className='modullar_ptag'>Real Estate Tokenization & Investment Platform
</p>
                        </div>
                        <Link href="/contact">
                    ...
                    {/* <div className='services_sidess'>
                        ...
                        <img src='\Assets\lo11.png' className='imgggs' />
                    </div>
                    <div className='challenge_div'>
                        <div>

                            <p>Golden Loonie is a blockchain-powered investment platform that enables fractional ownership of real estate through secure, tokenized assets. Designed for both seasoned and first-time investors, the platform opens up
                            traditionally high-barrier markets through smart contracts  transparent
                            </p>
                        </div>
                        <div>

                            <p>compliance systems, and real-time liquidity. With a focus on accessibility and compliance, Golden Loonie offers a seamless gateway for users to participate in high-value assets using blockchain infrastructure.
                    ...
                    <div className='goals_sidee'>
                        ...
                        <div className='imgs_seconds'>
                            <img src='\Assets\lo12.png' className='imgnew' />
                            <div>
                                <h2>Client Management Module</h2>
                                <p>Secure onboarding and investor tracking.</p>
                                <ul>
                                    <li>Integrated KYC/AML checks via Sumsub</li>
                                    <li>Investor portfolio overviews and activity tracking</li>
                                    <li>Investor portfolio overviews and activity tracking</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div>
                                ...
                                <p>Turn real estate into tradable digital assets.</p>
                                <ul>
                                    <li>ERC-20 token creation for fractional property ownership</li>
                                    <li>Smart contract-backed asset registry and compliance layer</li>
                                    <li>Enables secondary market trading and liquidity</li>
                                </ul>
                            </div>
                            <img src='\Assets\lo13.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\lo14.png' className='imgnew' />
                            <div>
                                <h2>Administration Panel</h2>
                                <p>Complete control and compliance oversight.</p>
                                <ul>
                                    <li>Admin-level monitoring of platform activity</li>
                                    <li>Automated reporting and alerts for security/compliance events</li>
                                    <li>Role-based access to system management features</li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                        <div>
                                <h2>Authentication & Communication</h2>
                                <p>Safe access and investor interaction.</p>
                                <ul>
                                    <li>User login secured with Twilio-powered 2FA</li>
                                    <li>Wallet connection for decentralized transaction signing</li>
                                    <li>Real-time notifications for KYC status, trades, and updates</li>
                                </ul>
                            </div>
                            <img src='\Assets\lo15.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\lo16.png' className='imgnew' />
                            <div>
                                <h2>Investor Dashboard</h2>
                                <p>User-centric tools for portfolio growth.</p>
                                <ul>
                                    <li>Live asset performance tracking</li>
                                    <li>Token ownership breakdown and transaction explorer</li>
                                    <li>Seamless buy/sell functionality with integrated wallet support</li>
                                </ul>
                            </div>
                        </div>
                    </div>
