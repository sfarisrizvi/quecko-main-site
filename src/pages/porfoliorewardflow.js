...
<p className='modullar_ptag'>Web3 Task & Community Reward Platform
</p>
                        </div>
                        <Link href="/contact">
                    ...
                    {/* <div className='services_sidess'>
                        ...
                        <img src='\Assets\re11.png' className='imgggs' />
                    </div>
                    <div className='challenge_div'>
                        <div>

                            <p>Reward Flow is a gamified engagement system designed to help Web3 projects grow and reward their communities. Inspired by platforms like Galxeand Zealy, it allows users to complete tasks, level up ranks, and earn

                            </p>
                        </div>
                        <div>

                            <p>token incentives through structured campaigns and community interaction.
                            Built for scalability and real-time performance, Reward Flow provides a modular system that tracks user participation and transforms attention into measurable impact.
                    ...
                    <div className='goals_sidee'>
                        ...
                        <div className='imgs_seconds'>
                            <img src='\Assets\re12.png' className='imgnew' />
                            <div>
                                <h2>User Onboarding System</h2>
                                <p>Quick and intuitive entry for contributors.</p>
                                <ul>
                                    <li>
                                    Wallet-based login and profile creation
                                    </li>
                                    <li>
                                    Activity tracking from day one
                                    </li>
                                    <li>
                                    Frictionless onboarding for Web3-native and new user
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div>
                                <h2>Task Management & Reward Engine</h2>
                                <p>Mission-based user engagement.</p>
                                <ul>
                                    <li>
                                    Assign tasks like follows, shares, signups, or contract interactions                                    </li>
                                    <li>
                                    Reward users with tokens or XP                                    </li>
                                    <li>
                                    Smart scoring tied to difficulty and importance                                    </li>
                                </ul>
                            </div>
                            <img src='\Assets\re13.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\re14.png' className='imgnew' />
                            <div>
                                <h2>Rank-Based Progression</h2>
                                <p>Climb the ranks. Unlock more.</p>
                                <ul>
                                    <li>
                                    Users earn ranks based on completed tasks and XP                                  </li>
                                    <li>
                                    Higher ranks unlock increased rewards                                  </li>
                                    <li>
                                    Real-time leaderboard to incentivize competition                                   </li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                        <div>
                                <h2>In-App Chat Module</h2>
                                <p>Connect and grow together.</p>
                                <ul>
                                    <li>
                                    Community chat system built into the platform                                    </li>
                                    <li>
                                    Rank-based badges and group discussions                                    </li>
                                    <li>
                                    Task-focused collaboration channels
                                    </li>
                                </ul>
                            </div>
                            <img src='\Assets\re15.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\re16.png' className='imgnew' />
                            <div>
                                <h2>Admin Dashboard & Campaign Control</h2>
                                <p>Complete control for project managers.</p>
                                <ul>
                                    <li>
                                    Task creation, duplication, and live editing                                 </li>
                                    <li>
                                    Campaign tracking with performance analytics                                </li>
                                    <li>
                                    Export tools and wallet-based user stats                                  </li>
                                </ul>
                            </div>
                        </div>
                    </div>
