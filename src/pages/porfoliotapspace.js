...
<p className='modullar_ptag'> Tap-to-Earn Gaming & Web3 Onboarding Platform
</p>
                        </div>
                        <Link href="/contact">
                    ...
                    {/* <div className='services_sidess'>
                        ...
                        <img src='\Assets\tap11.png' className='imgggs' />
                    </div>
                    <div className='challenge_div'>
                        <div>

                            <p>TapSpace is a gamified mini-game ecosystem built to onboard Web2 users into Web3 through fun, accessible, and rewarding gameplay. With tap-to-earn mechanics at its core, TapSpace lets players earn tokens by completing daily tasks, leveling up through space-themed missions, and participating
                            </p>
                        </div>
                        <div>

                            <p> in mini-games — all from a Telegram-based experience. Built for expansion, TapSpace also supports token airdrops, NFT marketplaces, referral systems, and social engagement, creating a complete entry point into decentralized gaming.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='goals_sidee'>
                        ...
                        <div className='imgs_seconds'>
                            <img src='\Assets\tap12.png' className='imgnew' />
                            <div>
                                <h2>Tap-to-Earn Gameplay</h2>
                                <p>Simple mechanics. Real rewards.</p>
                                <ul  className="custom-list">
                                    <li>Players earn tokens by tapping, leveling up, and completing tasks</li>
                                    <li>Daily login rewards grow progressively over a 7-day streak</li>
                                    <li>Space-themed progression with planets representing user tiers</li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                        <div>
                                <h2>Level Progression & Achievements</h2>
                                <p>Gamified milestones for deeper engagement.</p>
                                <ul>
                                    <li>Explore space from Earth to Neptune</li>
                                    <li>Each level unlocks new rewards and visuals</li>
                                    <li>Users gain XP and achievements with gameplay</li>
                                </ul>
                            </div>
                            <img src='\Assets\tap13.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\tap14.png' className='imgnew' />
                            <div>
                                <h2>Space Store</h2>
                                <p>Strategic item collection and upgrades.</p>
                                <ul>
                                    <li>Unlock items to boost mission success rate</li>
                                    <li>Earn and spend in-game tokens for upgrades</li>
                                    <li>Earn and spend in-game tokens for upgrades</li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                        <div>
                                <h2>Referral & Social Task System</h2>
                                <p>Growth through community engagement.</p>
                                <ul>
                                    <li>Invite friends to earn up to 25,000 tokens</li>
                                    <li>Complete tasks like following social accounts to earn more</li>
                                    <li>Leaderboards to gamify competition and loyalty</li>
                                </ul>
                            </div>
                            <img src='\Assets\tap15.png' className='imgnew' />
                        </div>
                    </div>
