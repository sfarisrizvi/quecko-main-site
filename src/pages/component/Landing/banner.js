      ...
      <section className="main_banner" id="banner">
        ...
        <div className="inner_banner">
          ...
          <div className="textual_inner">
            <p className="para_new">We’re the</p>
            <div className="animation-section style-1">
              <h1 ref={textRef}> Building Blocks</h1>
            </div>

            <p>Quecko is a leading blockchain development and marketing company. We empower Web3 startups to turn ideas into reality by building scalable, secure solutions like dApps, DeFi platforms, and NFT marketplaces. From consulting to skilled developers, we’re here to support your blockchain journey.
            </p>
          </div>
