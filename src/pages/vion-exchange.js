...
<p className='modullar_ptag'>Decentralized Crypto Exchange for Direct User Trades
                    ...
                    <div className='challenge_div'>
                        <div>
                            ...
                            <p>The P2P Trading Platform is a secure, cryptocurrency marketplace that enables users to buy and sell digital assets directly with each other — no intermediaries. Designed with an escrow system, dispute resolution tools,
                            </p>
                        </div>
                        <div>

                            <p>and real-time transaction tracking, the platform ensures safe and efficient fiat-to-crypto and crypto-to-crypto exchanges.Built for scalability and trust, this P2P engine gives users full control over their transactions while maintaining platform-level compliance and operational transparency.
                    ...
                    <div className='goals_sidee'>
                        ...
                        <div className='imgs_seconds'>
                            <img src='\Assets\vion112.png' className='imgnew' />
                            <div>
                                <h2>Secure Escrow System</h2>
                                <p>Trustless transaction protection for both parties.</p>
                                <ul>
                                    <li>Smart contract-powered escrow holding for trades    </li>
                                    <li>Funds are only released once both sides confirm completion</li>
                                    <li>Prevents fraud and builds user trust in every transaction</li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                        <div>
                        <h2>Real-Time Trade Matching</h2>
                                <p>Instantly connect buyers and sellers across markets.</p>
                                <ul>
                                    <li>Smart matching engine based on price, region, and payment method</li>
                                    <li>Supports one-to-one or multi-offer negotiation</li>
                                    <li>Integrated rating and reputation system</li>
                                </ul>
                            </div>
                            <img src='\Assets\vion113.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\vion114.png' className='imgnew' />
                            <div>
                                <h2>Multi-Payment Integration</h2>
                                <p>Flexibility for all user preferences.</p>
                                <ul>
                                    <li>Supports bank transfers, UPI, mobile wallets, and        stablecoins</li>
                                    <li>Custom payment method setup by merchants</li>
                                    <li>Multi-stage validator rewards model with diminishing       incentives</li>\
                                    <li>Payment confirmation and timestamp verification features</li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                        ...
                        <h2>Dispute Resolution System</h2>
                                <p>Platform-moderated conflict handling.</p>
                                <ul>
                                    <li>Escalation system for unresolved or disputed trades</li>
                                    <li>Admin panel for monitoring and intervention</li>
                                    <li>Secure message logs and trade proof uploads for fairness</li>
                                </ul>
                            </div>
                            <img src='\Assets\vion115.png' className='imgnew' />
                        </div>
                        <div className='imgs_seconds'>
                            <img src='\Assets\vion116.png' className='imgnew' />
                            <div>
                                <h2>User & Merchant Dashboard</h2>
                                <p>Powerful tools for managing trades and revenue.</p>
                                <ul>
                                    <li>Users can track trade history, balance, and open offers</li>
                                    <li>Verified merchant module with dedicated tools and badges</li>
                                    <li>Real-time wallet balance updates and withdrawal options</li>
                                </ul>
                            </div>
                        </div>
                        <div className='imgs_seconds newcardssss'>
                        <div>
                        <h2>Admin Panel & Compliance Controls</h2>
                                <p>Centralized oversight with full transparency.</p>
                                <ul>
                                    <li>KYC/AML enforcement through integrated tools</li>
                                    <li>Blacklist & fraud detection system</li>
                                    <li>Commission settings, withdrawal limits, and trade alerts</li>
                                </ul>
                            </div>
                            <img src='\Assets\vion117.png' className='imgnew' />
                        </div>
                    </div>
