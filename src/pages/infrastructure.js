            ...
            <section className='smart_contract'>
                ...
                <div className='Development'>
                    ...
                    <div className='mains_cardss'>
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>Full Node & Validator Setup
                            </h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>RPC & API Services</h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>Blockchain Explorer Development</h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5  className='names_tags'>Cross-chain & Interoperability Solutions
                            </h5>
                ...
                <div className='Application'>
                    <div className='inner__textt'>
                        <h6  className='contratt'>Why choose Infrastructure & Node Services for your business?
                        </h6>
                    ...
                    <div className='top_parents'>
                        <div className='parents_cards'>
                            <div className='cardee'>
                                ...
                                <h2>Enhanced Security & Reliability
                                </h2>
                        ...
                        <div className='parents_cards'>
                            ...
                            <div className='cardee'>
                                ...
                                <h2>Active Network Participation
