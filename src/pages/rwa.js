            ...
            <section className='smart_contract'>
                ...
                <div className='Development'>
                    ...
                    <div className='mains_cardss'>
                        <div className='card__one'>
                            ...
                            <h5   className='names_tags'>Asset Tokenization Architecture</h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5   className='names_tags'> Regulatory-Compliant Token Standards
                            </h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5   className='names_tags'> Smart Contract-Powered RWA Solutions
                            </h5>
                        ...
                        <div className='card__one'>
                            ...
                            <h5   className='names_tags'>Gas & Transaction Optimization
                            </h5>
                ...
                <div className='Application'>
                    <div className='inner__textt'>
                        <h6  className='contratt'>Why Should Your Business Leverage RWA Tokenization?
                        </h6>
